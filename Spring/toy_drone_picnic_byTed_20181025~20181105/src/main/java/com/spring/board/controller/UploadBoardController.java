...
public class UploadBoardController {
	...
	@Resource(name="uploadPath_board")
...
/*   uploadForm(get/post)  */			
/*-------------------------*/			
	@RequestMapping(value = "/uploadForm.bo", method = RequestMethod.GET)
	public void uploadForm() {		
		logger.info("uploadForm----GET-------");		
	}
	
	@RequestMapping(value = "/uploadForm.bo", method = RequestMethod.POST)
...
/*   uploadAjax(get/post)  */			
/*-------------------------*/	
	@RequestMapping(value = "/uploadAjax.bo", method = RequestMethod.GET)
	public void uploadAjax() {
			logger.info("uploadAjax----GET-------");
	}

	@RequestMapping(value = "/uploadAjax.bo", method = RequestMethod.POST,	produces = "text/plain; charset=UTF-8")
...
/*---------------*/
	  @ResponseBody
	  @RequestMapping(value="/deleteFile.bo", method=RequestMethod.POST)
	  ...
	  @ResponseBody
	  @RequestMapping(value="/deleteAllFiles.bo", method=RequestMethod.POST)
