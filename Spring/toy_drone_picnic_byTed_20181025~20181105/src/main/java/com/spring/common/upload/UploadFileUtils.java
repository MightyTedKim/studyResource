package com.spring.common.upload;
...
public class UploadFileUtils {
	...
	private static String makeThumbnail(
		...
		// to check
		logger.info("==========="); // BufferedImage@4e10c037: type = 6 ColorModel: #pixelBits = 32 numComponents = 4 color space = java.awt.color.ICC_ColorSpace@5a42e5c6 transparency = 3 has alpha = true isAlphaPre = false ByteInterleavedRaster: width = 583 height = 261 #numDataElements 4 dataOff[0] = 3
