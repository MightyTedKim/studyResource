...
<style style="text/css">
	...
	.back {background-color:gray; opacity:0.5; 
		width:100%; height:300%; overflow:hidden; z-index:1101;}
	.front {opacity:1; boarder:1px; margin:auto; z-index:1110;}
	.show {
		position:relative;
		max-width:1200px;
		max-height:800px;
...
<!-- Modal for image: don't move this -->
...
<!-- handlbars -->
<!-- --------- -->
<!-- attach template for read : no small x -->
...
/* ---------- */
    ...
    $(window).load(function(){
    	...
    	/*-----------------------*/
	   	...
	   	// should be first page among the existing list 
...
//read 	**function**
	function getPage(pageInfo) { //int pageInfo
		$.getJSON(pageInfo, function(data) {
			printData(data.list, $("#repliesDiv"), $('#template')); // function(replyArr, target, templateObject)
			printPaging(data.pageMaker, $(".pagination"));// function(pageMaker, target)
