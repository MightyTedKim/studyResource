...
function getFileInfo(fullName){
	...
	if(checkImageType(fullName)){ 
		...
		imgsrc ="/displayFile?fileName=" + fullName; //2
		fileLink = fullName.substr(14); //3 
		getLink = "/displayFile?fileName=" + front + end; //4
	}else{
		//if not image
		imgsrc ="/resources/dist/img/file.png"; //2
		fileLink = fullName.substr(12); //3 
		getLink = "/displayFile?fileName=" + fullName; //4
	}
